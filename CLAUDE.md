...
| Complication icon | **RGBA template PNG** — vibrant mode ignores RGB, only alpha determines brightness. Bright half alpha=255, dark half alpha=90. Generated by Python/Pillow. Do NOT use SwiftUI shapes/Canvas. |
